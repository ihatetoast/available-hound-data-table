...
## Why
Just to have as a reference and it's kind of fun to play around with options, filter, and sorting. The data is hardcoded from the GALT website, so it is not current. 
